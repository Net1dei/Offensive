...
def plot_hist(column):
    ...
    plt.savefig(f"./front/graphs/hist_{column.name}.png")
...
def plot_colors(column):
    ...
    ax.scatter(xs, ys, zs, depthshade=False, c=colors,
               s=[100 for n in range(len(colors))])
    ax.scatter([0, 0, 255], [0, 255, 0], [255, 0, 0], depthshade=False, c=[
               [0, 0, 1], [0, 1, 0], [1, 0, 0]], s=[500, 500, 500])
    plt.savefig(f"./front/graphs/цвета.png")
